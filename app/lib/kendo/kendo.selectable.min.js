...
!function (define) {
    return define(["./kendo.core.min", "./kendo.userevents.min"], function () {
        !function (e) {
            function t(e, t) {
                var n = s.getOffset(e), i = t.left + t.width, l = t.top + t.height;
            ...
            var i, s = window.kendo, l = s.ui.Widget, a = e.proxy, o = Math.abs, r = "aria-selected", c = "k-state-selected", u = "k-state-selecting", f = "k-selectable", d = "change", v = ".kendoSelectable", m = "k-state-unselecting", h = !1;
            !function (e) {
                !function () {
            ...
            }(e), i = l.extend({init: function (t, n) {
                var i, o = this;
                l.fn.init.call(o, t, n), o._marquee = e("<div class='k-marquee'><div class='k-marquee-color'></div></div>"), o._lastActive = null, o.element.addClass(f), i = o.options.multiple, o.userEvents = new s.UserEvents(o.element, {global: !0, allowSelection: !0, filter: (h ? "" : "." + f + " ") + o.options.filter, tap: a(o._tap, o)}), i && o.userEvents.bind("start", a(o._start, o)).bind("move", a(o._move, o)).bind("end", a(o._end, o)).bind("select", a(o._select, o))
            }, events: [d], options: {name: "Selectable", filter: ">*", multiple: !1}, _tap: function (t) {
                var n, i = e(t.target), s = this, l = t.event.ctrlKey || t.event.metaKey, a = s.options.multiple, o = a && t.event.shiftKey, r = t.event.which, u = t.event.button;
                ...
                var n = this, i = e(t.target), s = i.hasClass(c), l = t.event.ctrlKey || t.event.metaKey;
                return n._downTarget = i, i.closest("." + f)[0] !== n.element[0] ? (n.userEvents.cancel(), n._downTarget = null, undefined) : (n._marquee.appendTo(document.body).css({left: t.x.client + 1, top: t.y.client + 1, width: 0, height: 0}), l || n.clear(), s && (n._selectElement(i, !0), l && i.addClass(m)), undefined)
            }, _move: function (e) {
                var t = this, i = {left: e.x.startLocation > e.x.location ? e.x.location : e.x.startLocation, top: e.y.startLocation > e.y.location ? e.y.location : e.y.startLocation, width: o(e.x.initialDelta), height: o(e.y.initialDelta)}, s = t.element.find(t.options.filter);
                t._marquee.css(i), n(s, t._downTarget[0], i, e.event.ctrlKey || e.event.metaKey), e.preventDefault()
            }, _end: function () {
                var e = this;
                ...
                var t = this, n = a(t._selectElement, t);
                ...
                var i = e(t), s = !n && this._notify("select", {element: t});
                ...
                var n = "input,a,textarea,.k-multiselect-wrap,select", i = s.support.browser.msie;
                ...
                var i, s, l, o, r = this, u = !1, f = r.element.find(r.options.filter), v = a(r._selectElement, r);
